    ...
    <div className="relative w-full overflow-x-hidden">
      ...
      <header className="h-20 w-full px-10 md:px-20 flex justify-between items-center bg-white/5 text-white fixed top-0 left-0 z-50 backdrop-blur-sm">
        ...
        <nav className="flex items-center gap-6">
          ...
          <div className="flex gap-4">
            <button className="px-4 py-2 duration-200 cursor-pointer border border-gray-400 hover:bg-gray-400 rounded-lg text-white font-semibold hover:text-black/70">Cadastrar-se</button>
            <button className="px-4 py-2 duration-200 cursor-pointer bg-black/70 hover:bg-gray-400 rounded-lg text-white font-semibold border border-gray-400 hover:text-black/70">Jogar agora</button>
          </div>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen text-center px-10 pt-28">
        ...
        <div className="mt-10 flex gap-6">
          <button className="px-6 py-3 duration-150 font-extrabold rounded-lg cursor-pointer text-gray-200 hover:text-black border-gray-400 border-2 text-2xl hover:bg-gray-400">Download</button>
          <button className="px-6 py-3 duration-150 rounded-lg cursor-pointer text-gray-200 hover:text-black border-2 border-gray-400 font-semibold hover:bg-gray-400">Saber Mais</button>
        </div>
      </main>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center w-full gap-10 px-10 py-20">
        <div className="bg-gradient-to-br from-black/95 to-red-900/30 border border-red-600/10 p-8 rounded-2xl w-full md:w-1/2 flex flex-col items-center shadow-lg">
          ...
          <form className="w-full space-y-4">
            ...
            <div className="flex justify-center">
              <button className="hover:bg-gray-400 px-8 cursor-pointer py-2 rounded-lg bg-gray-200 text-black font-semibold duration-150">Enviar</button>
            </div>
          </form>
        </div>
        ...
        <div className="bg-gradient-to-br from-black/95 to-red-900/20 border border-red-600/10 p-8 rounded-2xl w-full md:w-1/3 flex flex-col items-center justify-center shadow-lg text-center">
          ...
          <button className="px-8 py-3 bg-red-700 hover:bg-red-400/70 cursor-pointer text-white font-semibold rounded-lg shadow-lg duration-200">Apoiar Agora</button>
        </div>
      </section>
